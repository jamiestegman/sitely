...
img_full: /images/stripe/stripe_full.png
...
Put the canvas inside a shaped div with overflow hidden, set a few CSS variables for the gradient colors (you can find the ones that Stripe uses in the sidebar of this page), then stack the layers of text inside a relatively positioned wrapper and voila!
...
<div style="margin: 2rem 0;"><button class="stripe-btn stripe-btn-primary">Click me!</button> <button class="stripe-btn">Click me!</button></div>
